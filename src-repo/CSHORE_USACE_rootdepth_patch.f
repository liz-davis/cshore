...
c begin bdj 2016-01-12 
          ...
          STREAMSTRESSSTA = 0.0D0 !bdj 2024-09-17 
...
C             IF(DUM.GT.10.D0) DUM=10.D0
          ...
          DO 200 ITEH=1,20
            ...
            ENDIF
            HWD(JP1)=H2/Y
            if (hwd(jp1).gt.hwd(jp1-1)) hwd(jp1) = hwd(jp1-1) !bdj 2021-01-21  
            Y=H1/HWD(JP1)
