...
% ---------------------------
% Find all infile files for shallow_collision_2
% across all profile folders
% ---------------------------
f = dir(fullfile(run_root, 'shallow_collision_2/', 'Test*', "*", 'infile'));

fprintf('Found %d infiles for  shallow_collision_2\n', numel(f));
